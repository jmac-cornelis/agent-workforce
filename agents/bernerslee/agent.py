...
from agents.bernerslee.models import (
    TraceabilityRecord,
    RelationshipEdge,
    TraceQuery,
    CoverageGapRecord,
...
class BernersLeeAgent(BaseAgent):
    '''
    Traceability agent.
    ...
    def _load_system_prompt() -> str:
        ...
        log.warning(f'Berners-Lee system prompt not found: {prompt_path}')
        return 'You are Berners-Lee, the Traceability agent for Cornelis Networks.'

    def run(self, input_data: Any) -> AgentResponse:
        '''
        Run the Berners-Lee agent.
