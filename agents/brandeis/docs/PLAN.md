...
Brandeis logs all compliance decisions with full context:
...
Brandeis is designed for maximum deterministic operation:
...
ComplianceRecord production, Hedy integration for release gating
