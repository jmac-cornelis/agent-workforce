...
from agents.shackleton.models import (
    DeliverySnapshot,
    DeliveryRiskRecord,
    ForecastRecord,
    StatusSummary,
...
class ShackletonAgent(BaseAgent):
    '''
    ...
    Gantt plans; Shackleton watches delivery reality and flags drift.
    ...
    def _load_system_prompt() -> str:
        ...
        log.warning(f'Shackleton system prompt not found: {prompt_path}')
        return 'You are Shackleton, the Delivery Manager agent for Cornelis Networks.'

    def run(self, input_data: Any) -> AgentResponse:
        '''
        Run the Shackleton agent.
