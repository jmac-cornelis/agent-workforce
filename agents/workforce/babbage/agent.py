...
class BabbageAgent(BaseAgent):
    ...
    def _load_system_prompt() -> str:
        ...
        log.warning(f'Babbage system prompt not found: {prompt_path}')
        return 'You are Babbage, the Version Manager agent for Cornelis Networks.'
    ...
    def run(self, input_data: Any) -> AgentResponse:
        '''
        Run the Babbage agent with the given input.
    ...
    def map_build_to_version(
        ...
        Input:
            ...
            release_context: Optional release context from Hedy.
