...
from agents.pliny.models import (
    MeetingRecord,
    TranscriptRecord,
...
class PlinyAgent(BaseAgent):
    ...
    def _load_system_prompt() -> str:
        ...
        log.warning(f'Pliny system prompt not found: {prompt_path}')
        return 'You are Pliny, the Knowledge Capture agent for Cornelis Networks.'
