...
- replacing Hedy as the release-decision authority
...
- Brooks measures delivery reality against those plans
...
## Architecture
### Core design
Brooks should be split into these concerns:
...
Exit criteria:
- Brooks can create a durable delivery snapshot
