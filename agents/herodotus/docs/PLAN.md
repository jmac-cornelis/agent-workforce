...
## Architecture
### Core design
Herodotus should be split into these concerns:
...
Herodotus should treat transcript availability as the gating condition for v1:
...
sequenceDiagram
    ...
    participant H as Herodotus API
